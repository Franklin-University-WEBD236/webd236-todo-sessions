        ...
        <tr>
          ...
          <td>
            <div class="btn-toolbar align-middle float-right">
              ...
              <button class="btn btn-secondary d-flex justify-content-center align-content-between bg-primary mr-1" onclick="location.href='@@todo/edit/{{$todo['id']}}@@'"><span class="material-icons">mode_edit</span></button>
